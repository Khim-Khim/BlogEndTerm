...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
     <base href="{{asset('public/fontend')}}"></base> 
    <!-- Site Metas -->
    ...
    <!-- Custom styles forpublic/ this template -->
    <link href="fontend/style.css" rel="stylesheet">
    <!-- Responsive styles for this template -->
    <link href="fontend/css/responsive.css" rel="stylesheet">

    <!-- Colors for this template -->
    <link href="fontend/css/colors.css" rel="stylesheet">

     <link href="public/fontend/css/log/Signup.css" rel="stylesheet">
    <!-- Version Garden CSS for this template -->
    <link href="fontend/css/version/garden.css" rel="stylesheet">
    <!-- css -->
...
@include('footer')
    ...
    <script src="fontend/js/tether.min.js"></script>
...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyAkADq7R0xf6ami9YirAM1N-yl7hdnYBhM "></script>
   <!-- MAP & CONTACT -->
    <script src="fontend/js/garden-map.js"></script>
...
<script src="dochoi/ckfinder/ckfinder.js"></script>
<script src="dochoi/ckeditor/ckeditor.js"></script>
<script type="text/javascript">
    CKEDITOR.replace( 'ckeditor1',{
        filebrowserImageUploadUrl : "{{ url('uploads-ckeditor?_token='.csrf_token()) }}",
        filebrowserBrowseUrlUrl : "{{url('file-browser?_token='.csrf_token()) }}",
