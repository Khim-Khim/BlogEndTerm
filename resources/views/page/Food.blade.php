            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-leaf bg-green"></i> Food tour </h2>
                    </div><!-- end col -->
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('trangchu')}}">trang chủ</a></li>
                            <li class="breadcrumb-item">Food tour </li>
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="{{route('chitiet',$foods->id_status)}}" title="">
                                                <img src="fontend/images/image/{{$foods->image}}" style="width: 260px; height: 200px;" class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <h4><a href="{{route('chitiet',$foods->id_status)}}" title="">{{$foods->title}}</a></h4>
                                        <p>{!!$foods->description!!}</p>
                                        
                                        <small><a href="garden-single.html" title="">{{$foods->created_at}}</a></small>
