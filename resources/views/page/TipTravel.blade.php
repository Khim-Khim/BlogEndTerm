            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-leaf bg-green"></i> Tip cần biết khi đi du lịch</h2>
                    </div><!-- end col -->
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('trangchu')}}">trang chủ</a></li>
                            <li class="breadcrumb-item">Tip du lịch </li>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-list clearfix">
                                ...
                                @foreach($tiptravel as $tr)

                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                             <a href="{{route('chitiet',$tr->id)}}" title="">
                                                <img src="fontend/images/image/{{$tr->image}}" style="width: 260px; height: 200px;" class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <h4><a href="{{route('chitiet',$tr->id_status)}}" title="">{{$tr->title}}</a></h4>
                                        <p>{!!$tr->description!!}</p>
                                        
                                        <small><a href="garden-single.html" title="">{{$tr->created_at}}</a></small>
                                        <small><a href="#" title=""></a>{{$tr->name}}</small>
                                    </div><!-- end meta -->
                                </div><!-- end blog-box -->
                       ...
                       <div class="row">{{$tiptravel->links()}}</div>
                    </div><!-- end col -->
